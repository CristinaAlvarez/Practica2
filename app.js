...
const DIRECCION_REQUIRED = "Por favor introduzca su direccion";
...
form.addEventListener("submit", function (event) {
	...
	let direccionValid = hasValue(form.elements["address"], DIRECCION_REQUIRED);
